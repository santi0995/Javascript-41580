...
//     console.log("Su tarjeta ha sido rechazada");
// }
// else if(tipoEmpleado == "independiente" && actividad <= 3 && ingresos < 1000){
//     console.log("Su tarjeta ha sido rechazada");
// }
// else if(tipoEmpleado == "empleado" && tipoDeContrato == "contratista" &&  ingresos < 500){
//     alert("Su tarjeta ha sido rechazada");
// }
// else if(documento % 2 != 0){
//     console.log("Su tarjeta ha sido rechazada");
// } else{
//     if(tieneTarjeta != "Si" && ingresos > 1000 && gastos <= 600 && tipoEmpleado == "empleado"){
//         cupo = 2000
//         console.log(`El cupo aprobado es de ${cupo} dolares`)
//     } else if (tieneTarjeta != "Si" && ingresos > 2000 && gastos <= 600 && tipoEmpleado == "empleado" || tipoEmpleado == "independiente" ) {
//         cupo = 3000
//         console.log(`El cupo aprobado es de ${cupo} dolares`)
//     } else{
//         cupo = 1200
//         console.log(`Cupo minimo aprobado de ${cupo} dolares`)
//     }
// }
